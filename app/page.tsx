...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "鍼灸・マッサージ・アロマは受けられますか？", acceptedAnswer: { "@type": "Answer", text: "当院は整体（骨格・姿勢矯正）専門のため、鍼灸・マッサージ・アロマ・エステ施術は行っておりません。" } },
    { "@type": "Question", name: "SNSや公式LINEはありますか？", acceptedAnswer: { "@type": "Answer", text: "現在、Instagram・X（Twitter）等のSNSアカウントおよびLINE公式アカウントは運営しておりません。ご予約はLINE個人アカウントまたはお問い合わせフォームからお願いします。" } },
  ],
};
...
const faqs = [
  ...
  { q: "予約方法を教えてください", a: "LINEまたはお問い合わせフォームからご予約いただけます。電話予約・当日飛び込みはお受けしておりません。" },
  { q: "駐車場はありますか？", a: "専用駐車場はございません。近隣のコインパーキングをご利用ください。" },
  { q: "鍼灸・マッサージ・アロマは受けられますか？", a: "当院は整体（骨格・姿勢矯正）専門のため、鍼灸・マッサージ・アロマ・エステ施術は行っておりません。" },
  { q: "SNSや公式LINEはありますか？", a: "現在、Instagram・X（Twitter）等のSNSアカウントおよびLINE公式アカウントは運営しておりません。ご予約はLINE個人アカウントまたはフォームからお願いします。" },
];
